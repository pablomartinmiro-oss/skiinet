...
export const DEMO_INVOICES: DemoInvoice[] = [
  ...
  { number: "FAC-2026-0004", status: "paid", subtotal: 661.16, taxAmount: 138.84, total: 800, issuedDaysAgo: 15, paidDaysAgo: 14, notes: "Grupo amigos — 4 pax",
    lines: [{ description: "Cursillo grupo + alquiler equipo (4 pax)", quantity: 4, unitPrice: 165.29, lineTotal: 661.16 }] },
  { number: "FAC-2026-0005", status: "paid", subtotal: 132.23, taxAmount: 27.77, total: 160, issuedDaysAgo: 10, paidDaysAgo: 9, notes: null,
